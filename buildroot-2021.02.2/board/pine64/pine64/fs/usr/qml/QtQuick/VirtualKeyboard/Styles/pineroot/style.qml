...
KeyboardStyle {
    ...
    readonly property real keyBackgroundMargin: Math.round(5 * scaleHint)
    readonly property real keyContentMargin: Math.round(5 * scaleHint)
    readonly property real keyIconScale: scaleHint * 0.2
    // readonly property int defaultKeyFontSize: 5
    ...
    keyboardDesignWidth: 720 // 2560
    keyboardDesignHeight: 400 // 800
    keyboardRelativeLeftMargin: 10 / keyboardDesignWidth
    keyboardRelativeRightMargin: 10 / keyboardDesignWidth
    keyboardRelativeTopMargin: 20 / keyboardDesignHeight // 13
    keyboardRelativeBottomMargin: 20 / keyboardDesignHeight
